...
#
#   testing testValidation.py 26.06.01
...
#
#   test 5 v2Validation: RDNAP2018v2 356 of 47754 tests FAILED, 7959 of 10000 points -inside (pyrdnap 26.6.1 pygeodesy 26.5.26 Python 3.14.5 64bit arm64 macOS 26.5) 393.347 ms
...
#
#   test 14 v1Validation: RDNAP2018v1 all 47754 tests PASSED, 7959 of 10000 points -inside (pyrdnap 26.6.1 pygeodesy 26.5.26 Python 3.14.5 64bit arm64 macOS 26.5) 479.921 ms
...
#
#   all 18 testValidation.py tests passed (pyrdnap 26.6.1 pygeodesy 26.5.26 Python 3.14.5 64bit arm64 macOS 26.5) 873.752 ms

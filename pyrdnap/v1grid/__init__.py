...
As a result, the first 28 and the last 169 rows (in total 197 rows
or 41% of 481) are represented by the same 301-array of
single-precision zeros.  There are other stretches of zeros, but
none amount to 301 or more.
'''
...
_lat_corr = _v_grid_txt(1, 'rdcorr', 2, _d_array, 89642)  # PYCHOK shared
_lon_corr = _v_grid_txt(1, 'rdcorr', 3, _d_array, 89433)  # PYCHOK shared
